...
export async function POST(req: NextRequest) {
  try {
    ...
    // Find internal user with a valid, unused PASSWORD_RESET OTP
    ...
    // Hash + save new password, invalidate all reset OTPs for this user
    ...
    console.error('[POST /api/auth/staff/reset-password]', err);
