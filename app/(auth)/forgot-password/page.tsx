  ...
  const handleSendCode = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        setEmail(trimmed);
        setResendIn(60);
        toast.info('Code sent', `If ${trimmed} matches an account, check your inbox.`);
        setStep('reset');
      } else {
      ...
      {step === 'email' && (
        <form onSubmit={handleSendCode} noValidate>
          ...
          <div className="mt-8">
            ...
            <Field label="Work email" htmlFor="fp-email" required>
              <Input
                id="fp-email"
                name="email"
                type="email"
      ...
      {step === 'reset' && (
        <form onSubmit={handleReset} noValidate>
          ...
          <div className="mt-7">
            ...
            <Field label="Confirm password" htmlFor="fp-confirm" required error={pwError}>
              <Input
                id="fp-confirm"
                type="password"
                placeholder="••••••••"
