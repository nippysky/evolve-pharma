 /**
 * Products list (client). Search + category filter on top of the
 * catalog. Imports its data directly since the catalog and inventory
 * arrays are pure JS modules with no server-only dependencies.
 */
