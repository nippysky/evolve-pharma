      ...
      <aside className="self-start space-y-4">
        ...
        <div className="rounded-xl border border-line bg-white p-5">
          ...
          <ul className="mt-3 space-y-2 text-sm">
            {[
              { label: 'Manage staff roles',  href: '/console/roles'   },
              { label: 'View staff list',     href: '/console/staff'   },
              { label: 'Manage drivers',      href: '/console/drivers' },
              { label: 'View reports',        href: '/console/reports' },
            ].map((l) => (
              <li key={l.href}>
